...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setting_image = findViewById(R.id.profile_set);
        setting_name = findViewById(R.id.set_name);
        setting_status = findViewById(R.id.set_status);
                                    ...
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful())
                                            {
                                                ...
                                                Toast.makeText(Settings.this, "Data Successfully Updated", Toast.LENGTH_SHORT).show();
